...
$(function () {
    ...
    if (username) {
        ...
        $.ajax({
            ...
            success: function (str) {
                ...
                $('.order_content').html('');
                // console.log(objCart);
                objCart.forEach(function (index, item) {
                    $.ajax({
                        'type': 'get',
                        'url': '../api/detail.php',
                        'data': {
                        ...
                        success: function (str) {
                            ...
                            let html = `<ul class="order_lists">
                                <li class="list_chk">
                                    <input type="checkbox" id="checkbox_${index+2}" class="son_check">
                                    <label for="checkbox_${index+2}"></label>
                                </li>
                                <li class="list_con">
                                ...
                                <li class="list_sum">
                                    <p class="sum_price">￥${obj.price*item.nums}</p>
                                </li>
                                <li class="list_op">
                                    <p class="del">
        ...
        for (let key in newObj) {
            $.ajax({
                ...
                success: function (str) {
                    ...
                    let html = `<ul class="order_lists">
                                <li class="list_chk">
                                    <input type="checkbox" id="checkbox_${index}" class="son_check">
                                ...
                                <li class="list_sum">
                                    <p class="sum_price">￥${obj.price*newObj[key]}</p>
                                </li>
                                <li class="list_op">
                                    <p class="del">
                                        <a href="javascript:;" class="shoucang">移入收藏夹</a>
    ...
    $('.whole_check').click(function () {
        ...
        if ($(this).is(':checked')) {
            ...
            $('#bottomCheck').addClass('mark'); //曲线救国
        } else {
            $checkboxs.prop("checked", false);
            $checkboxs.next('label').removeClass('mark');
            $('#bottomCheck').removeClass('mark'); //曲线救国
        }
        totalMoney();
    });
