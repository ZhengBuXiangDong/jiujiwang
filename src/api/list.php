<?php
    ...
    // 准备sql数据 
    $startNum = ($nowPage - 1) * $num;//当前页第一条数据的索引
    
    $sql1 = "SELECT * FROM product $condition ORDER BY $paixu LIMIT $startNum,$num;";  //一页的条数
    $sql2 = "select * from product $condition";  //获取符合要求的总项数
